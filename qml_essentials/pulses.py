...
class PulseEnvelope:
    ...
    REGISTRY = {
        ...
        "drag": {
            ...
            "n_envelope_params": 3,
            "defaults": {
                "RX": jnp.array([0.37551868680599,1.067264330560794,3.0546993908453604,3.0165851529539687]),
                "RY": jnp.array([0.3808899586006169,1.0564075884588096,3.038168432207336,2.9665915543423464]),
            },
        },
        "sech": {
            "fn": sech.__func__,
