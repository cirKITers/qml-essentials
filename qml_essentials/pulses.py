...
class PulseEnvelope:
    ...
    REGISTRY = {
        "gaussian": {
            ...
            "defaults": {
                "RX": jnp.array(
                    [0.5116726160049438,2.149970531463623,2.0165727138519287]
                ),
                "RY": jnp.array(
                    [0.5225026607513428,2.1136844158172607,1.966444730758667]
                ),
            },
        },
        "square": {
            ...
            "n_envelope_params": 2,
            "defaults": {
                "RX": jnp.array([1.0305306439099684,0.992028628405856,0.983514623830218]),
                "RY": jnp.array([1.0183928639951554,0.9920286321489998,0.9667250369039198]),
            },
        },
        "cosine": {
            "fn": cosine.__func__,
        ...
        "drag": {
            ...
            "n_envelope_params": 3,
            "defaults": {
                "RX": jnp.array([0.3734027011349582,1.0407098614557875,3.0979835581905677,3.015732250622645]),
                "RY": jnp.array([0.3770487904548645,1.002955436706543,3.0912559032440186,2.9698715209960938]),
            },
        },
        "sech": {
            "fn": sech.__func__,
