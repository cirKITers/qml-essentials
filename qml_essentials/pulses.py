...
class PulseEnvelope:
    ...
    REGISTRY = {
        ...
        "drag": {
            ...
            "n_envelope_params": 3,
            "defaults": {
                "RX": jnp.array([0.2786071433136506,0.512056372059176,4.649453067413332,3.784394081861129]),
                "RY": jnp.array([0.27727830556155175,0.4932721244300463,4.684858848392961,3.769308064739444]),
            },
        },
        "sech": {
            "fn": sech.__func__,
        ...
        "general": {
            ...
            "defaults": {
                "RZ": jnp.array([0.5]),
                "CZ": jnp.array([0.31830987741207367]),
            },
        },
    }
