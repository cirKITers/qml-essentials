...
class PulseEnvelope:
    ...
    REGISTRY = {
        "gaussian": {
            ...
            "defaults": {
                "RX": jnp.array(
                    [0.37834986322662195,1.6359369863190043,3.023377260907237]
                ),
                "RY": jnp.array(
                    [0.3836652398737185,1.6165959438186808,2.979413481266499]
                ),
            },
        },
        "square": {
            ...
            "n_envelope_params": 2,
            "defaults": {
                "RX": jnp.array([1.2096507924746667,0.8266848727633945,1.1483128671018599]),
                "RY": jnp.array([1.0237121996278535,0.9920221188300785,0.9768370426747028]),
            },
        },
        "cosine": {
            "fn": cosine.__func__,
        ...
        "drag": {
            ...
            "n_envelope_params": 3,
            "defaults": {
                "RX": jnp.array([0.3257465630197066,0.4062165067150349,5.377632600698692,3.148334221751331]),
                "RY": jnp.array([0.322496973121079,0.41242602748905116,7.076291548439022,3.1466773848215572]),
            },
        },
        "sech": {
            "fn": sech.__func__,
