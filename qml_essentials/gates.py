...
class PulseEnvelope:
    ...
    REGISTRY = {
        "gaussian": {
            ...
            "defaults": {
                "RX": jnp.array(
                    [17.076778490912307, 0.91542331350785, 0.7500510748780771]
                ),
                "RY": jnp.array(
                    [8.456476939331182, 0.9900492159060902, 1.0999044347846507]
                ),
            },
        },
        "square": {
        ...
        "general": {
            ...
            "n_envelope_params": 0,
            "defaults": {
                "RZ": jnp.array([1.0004458891217411]),
                "CZ": jnp.array([0.9548668545525948]),
            },
        },
    }
