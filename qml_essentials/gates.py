...
class PulseEnvelope:
    ...
    REGISTRY = {
        "gaussian": {
            ...
            "defaults": {
                "RX": jnp.array(
                    [16.093201780203064, 1.697143364838126, 0.9999896254319123]
                ),
                "RY": jnp.array(
                    [8.011995735259445, 1.9482118491256961, 0.9999997199722191]
                ),
            },
        },
        "square": {
        ...
        "general": {
            ...
            "n_envelope_params": 0,
            "defaults": {
                "RZ": jnp.array([0.9864445682988798]),
                "CZ": jnp.array([0.9308379382358022]),
            },
        },
    }
